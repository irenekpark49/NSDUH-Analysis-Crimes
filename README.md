...
First, I ran three weighted adjusted multivariable logistic regressions in the 2018-2019 combined dataset, none of which showed any significant association between MML and self-reported criminal behaviors. Then, I found that those surveyed in 2020 who lived in states with MML had higher odds of all three self-reported criminal behaviors. No significant interactions between the three predictor variables and covariates existed in the data.
