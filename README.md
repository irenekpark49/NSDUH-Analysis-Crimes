...
First, I ran three weighted adjusted multivariable logistic regressions in the 2020 dataset, none of which showed any significant association between MML and self-reported criminal behaviors. Then, I looked for any interaction between the three predictor variables and covariates, none of which were significant. Surprisingly, those who lived in states with MML had lower odds of all three self-reported criminal behaviors.  
